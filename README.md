...
1. копируем .env и прокидываем свои переменные:
   ...
   make env
2. REST:\
  http://localhost:3000/health - Статус бекенда (Можно всегда отвечать OK)\
  \
  ...
  http://localhost:3000/weather/by_time - Найти ближайшую температуру к переданному timestamp (например 1621823790 должен отдать температуру за 2021-05-24 08:00. Из имеющихся данных, если такого времени нет вернуть 404)
